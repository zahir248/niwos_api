...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO access_request (NW_AccessRequest_ID, StartTimeDate, EndTimeDate, Duration, Reason, SubmissionTimeDate, AccessRequestStatus_ID, AccessRequestArea_ID, id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
